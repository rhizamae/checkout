var Input, __bind = function(fn, me) {
  return function() {
      return fn.apply(me, arguments)
  }
},
__hasProp = {}.hasOwnProperty,
__extendsInput = function(child, parent) {
...
Input = function(_super) {
  ...
  Input.prototype.render = function() {
    ...
    //this.$input.addClass("customized");
    //$("#card-number").addClass("customized2");
    //$(".cardNumberInput").append(this.$input);
